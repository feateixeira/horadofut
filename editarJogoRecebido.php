...
$sql = mysqli_query($conexao,"SELECT * FROM jogo JOIN conta ON idUsuario1 = IdUsuario WHERE idJogo = {$_POST['idJogo']}");
...
<body class="bComum">
    ...
    <main class="cadastro">
        ...
        <form class="row g-3" method="post" action="editaJogoRecebido.php">
